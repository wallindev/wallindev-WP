...
<div class="crp-gallery-wrapper">
    <div class="crp-add-item-boxes">
        ...
        <div class="crp-add-item-box"><a id="crp-add-video-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Local Videos</div>'); ?>'>+ Add video (PRO)</a></div>
        <div class="crp-add-item-box"><a id="crp-add-youtube-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Youtube Videos</div>'); ?>'>+ Add youtube (PRO)</a></div>
        <div class="crp-add-item-box"><a id="crp-add-vimeo-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Vimeo Videos</div>'); ?>'>+ Add vimeo (PRO)</a></div>
        <div class="crp-add-item-box"><a id="crp-add-iframe-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for iFrames</div>'); ?>'>+ Add iframe (PRO)</a></div>
        <div class="crp-add-item-box"><a id="crp-add-map-button" class='button-secondary crp-add-project-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Maps</div>'); ?>'>+ Add map (PRO)</a></div>
    </div>
