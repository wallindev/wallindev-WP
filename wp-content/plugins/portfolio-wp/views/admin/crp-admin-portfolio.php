        ...
        <div class="crp-project-details-wrapper">
            ...
            <section class="crp-project-images-wrapper">
                <div class="crp-add-picture-button-wrapper">
                    ...
                    <a id="crp-add-video-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Local videos</div>'); ?>'>+ Video (PRO)</a>
                    <a id="crp-add-youtube-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Youtube videos</div>'); ?>'>+ Youtube (PRO)</a>
                    <a id="crp-add-vimeo-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Vimeo videos</div>'); ?>'>+ Vimeo (PRO)</a>
                    <a id="crp-add-iframe-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for iFrames</div>'); ?>'>+ Iframe (PRO)</a>
                    <a id="crp-add-map-button" class='button-secondary crp-add-picture-button crp-glazzed-btn crp-glazzed-btn-green tooltip' href='#' title='<?php echo htmlentities('<div class="crp-tooltip-content">Upgrade to Premium version for Maps</div>'); ?>'>+ Map (PRO)</a>
                </div>
    ...
    if(crp_portfolio.projects && crp_portfolio.corder){
        for(var crp_projectIndex = 0; crp_projectIndex < crp_portfolio.corder.length; crp_projectIndex++){
            ...
            if(crp_project.id == crp_selectedProjectId){
                ...
                jQuery("#crp-project-title").attr( "value", (crp_project.title ? CrpBase64.decode(crp_project.title) : '') );
                jQuery("#crp-project-description").attr( "value", CrpBase64.decode(crp_project.description) );
...
function crp_updateModel(){
  //To make sure it's valid JS object
    ...
    if(crp_selectedProjectId){
        ...
        crp_activeProject.title = CrpBase64.encode(jQuery("#crp-project-title").attr( "value" ));
        crp_activeProject.cover = CrpBase64.encode(jQuery("#crp-project-cover-src").attr( "value" ));
        crp_activeProject.description = CrpBase64.encode(jQuery("#crp-project-description").attr( "value" ));
